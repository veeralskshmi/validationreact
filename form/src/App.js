      ...
      <fieldset>
        <form action="#" method="get">
          ...
          <input type="radio" name="gender" id="male" value="male" checked={gender === "male"} onChange={(e)=> setGender(e.target.value)}  />
           ...
           Male<input type="radio" name="gender" id="female"  checked={gender === "female"} onChange={(e)=> setGender(e.target.value)}/>    
    
           Female<input type="radio" name="gender" id="other" checked={gender === "other"} onChange={(e)=> setGender(e.target.value)}/>
          Other
          ...
          <select name="select" id="select" value={selectedOption} onChange={(e)=>setSelectedOption(e.target.value)}>
            <option
            value=""
            disabled selected={selectedOption===""}>Select your Ans</option>
          ...
          <button type="submit" value="submit" coClick={(e) => handleSubmit(e)}>Submit</button>
